...
public class CustomExpandableListAdapter2 extends BaseExpandableListAdapter {
    ...
    private HashMap<String, usurmm> expandableListDetalles;



    public CustomExpandableListAdapter2(Context context, List<String> listTitulo, HashMap<String,  usurmm> expandableListDetalles) {
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final usurmm contacto = (usurmm) getChild(groupPosition, childPosition);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
      ...
      usurmm contacto = (usurmm) getChild(groupPosition,0);
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.item_usur, null);



        }
        TextView nom=(TextView)convertView.findViewById(R.id.textView8);
   TextView txtusuario=(TextView) convertView.findViewById(R.id.text);
