...
public class menuhahe1 extends AppCompatActivity implements ActionBar.TabListener, ViewPager.OnPageChangeListener {
...
static 	public String user;
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    JsonArrayRequest jsonArrayRequest=new JsonArrayRequest(Url, new Response.Listener<JSONArray>() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            hojavhe1.nombre.setText(promedioLista.get(p).getNombre());
                            hojavhe1.apellidos.setText(promedioLista.get(p).getApellido());
                            hojavhe1.fechan.setText(promedioLista.get(p).getFechaden());
                            hojavhe1.email.setText(promedioLista.get(p).getEmail());
                            hojavhe1.luagrdn.setText(promedioLista.get(p).getLugarden());
                            hojavhe1.edad.setText(promedioLista.get(p).getEdad());
                            hojavhe1.cc.setText(promedioLista.get(p).getCec());
                            hojavhe1.lugarex.setText(promedioLista.get(p).getLugardeex());
                            hojavhe1.ocupacion.setText(promedioLista.get(p).getOcupacion());
                            hojavhe1.direcc.setText(promedioLista.get(p).getDirecc());
                            hojavhe1.estadoc.setText(promedioLista.get(p).getEstadic());
                            hojavhe1.celular.setText(promedioLista.get(p).getCelular());
                    ...
                    String Ul="http://"+ipt+":80/AppAndroid/hestudi.php";
                     jsonArrayRequest=new JsonArrayRequest(Ul, new Response.Listener<JSONArray>() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            experiencehe1.primarios.setText(pres.get(p).getPrimarios());
                            experiencehe1.secundarios.setText(pres.get(p).getSecundarios());
                            experiencehe1.superiores.setText(pres.get(p).getSuperiores());
                            ...
                            for(int v=0;v<otr.length();v++){
                                ...
                                if(nos.equals("/")){
                                    if (r == 0) {
                                        experiencehe1.cursos.setText(palabra);
                                    }
                                    if(r==1){
                                        experiencehe1.cur2.setText(palabra);
                                    }
                                    r++;
                                    palabra="";
                                }else {
                                ...
                                if(r==2){
                                    experiencehe1.cur3.setText(palabra);
                                }
                            }
                    ...
                    jsonArrayRequest=new JsonArrayRequest(Ull, new Response.Listener<JSONArray>() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            for(int v=0;v<otr.length();v++){
                                ...
                                if(nos.equals("/")){
                                    if (r == 0) {
                                        experiencehe1.celurb.setText(palabra);
                                    }
                                    if(r==1){
                                        experiencehe1.cellrb2.setText(palabra);
                                    }
                                    r++;
                                    palabra="";
                                }else {
                                ...
                                if(r==2){
                                    experiencehe1.cellrb3.setText(palabra);
                                }
                            }
                            ...
                            for(int v=0;v<otr.length();v++){
                                ...
                                if(nos.equals("/")){
                                    if (r == 0) {
                                        experiencehe1.nombrerb.setText(palabra);
                                    }
                                    if(r==1){
                                        experiencehe1.nomrb2.setText(palabra);
                                    }
                                    r++;
                                    palabra="";
                                }else {
                                ...
                                if(r==2){
                                    experiencehe1.nomrb3.setText(palabra);
                                }
                            }
                            ...
                            for(int v=0;v<otr.length();v++){
                                ...
                                if(nos.equals("/")){
                                    if (r == 0) {
                                        experiencehe1.celurf.setText(palabra);
                                    }
                                    if(r==1){
                                        experiencehe1.celrf2.setText(palabra);
                                    }
                                    r++;
                                    palabra="";
                                }else {
                                ...
                                if(r==2){
                                    experiencehe1.celrf3.setText(palabra);
                                }
                            }
                            ...
                            for(int v=0;v<otr.length();v++){
                                ...
                                if(nos.equals("/")){
                                    if (r == 0) {
                                        experiencehe1.nombrerf.setText(palabra);
                                    }
                                    if(r==1){
                                        experiencehe1.nomrf2.setText(palabra);
                                    }
                                    r++;
                                    palabra="";
                                }else {
                                ...
                                if(r==2){
                                    experiencehe1.nomrf3.setText(palabra);
                                }
                            }
                            ...
                            for(int v=0;v<otr.length();v++){
                                ...
                                if(nos.equals("/")){
                                    if (r == 0) {
                                        experiencehe1.profesol.setText(palabra);
                                    }
                                    if(r==1){
                                        experiencehe1.profl2.setText(palabra);
                                    }
                                    r++;
                                    palabra="";
                                }else {
                                ...
                                if(r==2){
                                    experiencehe1.profl3.setText(palabra);
                                }
                            }
                            ...
                            for(int v=0;v<otr.length();v++){
                                ...
                                if(nos.equals("/")){
                                    if (r == 0) {
                                        experiencehe1.profesof.setText(palabra);
                                    }
                                    if(r==1){
                                        experiencehe1.proff2.setText(palabra);
                                    }
                                    r++;
                                    palabra="";
                                }else {
                                ...
                                if(r==2){
                                    experiencehe1.proff3.setText(palabra);
                                }
                            }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    tabFragment = new hojavhe1();
                    break;
                case 1:
                    tabFragment = new experiencehe1();
                    break;
            }
            return tabFragment;
        }
