...
public class buscaoferemple extends AppCompatActivity {
    ...
    static String user,cont;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buscaoferemple);
        ...
        JsonArrayRequest jsonArrayRequest=new JsonArrayRequest(Url, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                expandableListAdapter = new CustomExpandableListAdapter3(getApplicationContext(), expandableListNombres, listaContactos);


                ((CustomExpandableListAdapter3) expandableListAdapter).setInflater(activity);
